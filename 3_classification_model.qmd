...
#### Normality check of game prices across player classes
...
#### **Wilcoxon test for price differences between Low and Mid player classes**

```{r}
cat(with(df_app, wilcox.test(price_eur[avg_player_class == "Low"],
                    price_eur[avg_player_class == "Mid"])))
```

#### Predicting Player Popularity for a New Game
